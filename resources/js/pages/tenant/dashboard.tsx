    ...
    return (
        <ClubLayout title="Dashboard">
            ...
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                ...
                <StatTile label="Teams" value={stats.teams} href={route('tournaments.index')} />
            </div>

            {/* Uniform widget grid — each card is one cell; grid stretch keeps every row even. */}
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <Button asChild size="sm" variant="ghost">
                            <Link href={route('bookings.index')}>Open</Link>
                        </Button>
                    </CardHeader>
                    <CardContent>
